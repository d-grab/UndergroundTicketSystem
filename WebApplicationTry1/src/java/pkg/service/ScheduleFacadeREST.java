 ...
 */
@javax.ejb.Stateless
@javax.ws.rs.Path("pkg.schedule")
public class ScheduleFacadeREST extends AbstractFacade<Schedule> {

    @PersistenceContext(unitName = "WebApplicationTry1PU")
    ...
    @javax.ws.rs.Path("{id}")
    @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@javax.ws.rs.PathParam("id") Integer id, Schedule entity) {
        super.edit(entity);
    }
    ...
    public Schedule find(@javax.ws.rs.PathParam("id") Integer id) {
    ...
    @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Schedule> findRange(@javax.ws.rs.PathParam("from") Integer from, @javax.ws.rs.PathParam("to") Integer to) {
